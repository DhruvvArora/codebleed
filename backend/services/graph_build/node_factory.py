"""
CodeBleed — Node Factory.

Converts structured input into normalized flat dicts for the local graph.
"""

from schemas.graph_build import GraphBuildRequest

# Node label constants (inlined from graph_models)
    ...
    for commit in data.ingestion_data.commits:
        for f in commit.files:
            ...
            if file_id not in files:
                files[file_id] = {"label": LABEL_FILE, "file_id": file_id, "path": f.path}
